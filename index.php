...
?>
    <div class="hai">
        ...
        <div class="content">
            <h1>Drive Your <br><span> Dream Anytime</span></h1>
            <p class="par">Live the luxury you deserve.<br>
            Rent your dream car from our vast collection and drive in style.<br>Enjoy every ride, create unforgettable journeys.<br>
            join us and be part of something bigger. </p>
